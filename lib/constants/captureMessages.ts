...
export const CAPTURE_MESSAGES = {
  ...
  SAVE_NOW_ERROR: '儲存失敗，請重試 (╥﹏╥)',

  // Save previous (savePrevious method)
  SAVE_PREVIOUS_NOT_FOUND: '找不到上一則訊息 (´_ゝ`)',
  SAVE_PREVIOUS_ERROR: '儲存失敗，請重試 (╥﹏╥)',

  // Save quoted (saveQuoted method)
  SAVE_QUOTED_NOT_FOUND: '找不到被引用的訊息 (´_ゝ`)',
  SAVE_QUOTED_ERROR: '儲存失敗，請重試 (╥﹏╥)',
